...
🏦 Pojištění a penzijní připojištění (Insurance & Pension)
 - [ ] Penzijní připojištění — potvrzení pro daňový odpočet (every year)
 - [ ] Životní/úrazové pojištění — daňové potvrzení (every year) ⚠ Note: in last year's filing these two together exceeded the 48,000 CZK deduction limit — Iva had to remove the life insurance deduction

📑 Živnostenský list & daňová registrace (Business Registration)
 - [ ] Výpis z živnostenského rejstříku (every year)
 - [ ] Registrace k dani z příjmu (every year)
...
💰 Příjmy z podnikání (Business Income — if applicable)
 - [ ] Přehled přijatých plateb (xlsx — appeared in 2022, 2024 filings)
 - [ ] Seznam vydaných faktur (xlsx — appeared in 2024 filing)