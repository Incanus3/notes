...
- GPT-5.5 (low reasoning) - actually looks pretty great benchmark-wise - it has great intelligence, reliability, reasonable speed (not great, but better than Qwen) and isn't actually that costly, since it's apparently very token-efficient
